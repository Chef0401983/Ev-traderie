      ...
      {messages.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">
            When you receive messages about your listings or inquire about vehicles, they'll appear here.
          </p>
        </div>
      ) : (
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 mb-2">
                    {message.sender_id === user?.id ? (
                      ...
                      <span>From: {message.sender?.full_name || 'Unknown'} ({message.sender?.user_type || 'user'})</span>
                    )}
                  </div>
              ...
              <div className="border rounded-lg p-6">
                <div className="mb-4">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    {selectedMessage.sender_id === user?.id ? (
                      <span>To: {selectedMessage.recipient?.full_name || 'Unknown'} ({selectedMessage.recipient?.user_type || 'user'})</span>
                    ) : (
                      <span>From: {selectedMessage.sender?.full_name || 'Unknown'} ({selectedMessage.sender?.user_type || 'user'})</span>
                    )}
                  </div>
                ...
                {selectedMessage.vehicle && (
                  <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                    <h3 className="font-medium text-sm text-gray-700">Vehicle</h3>
                    <p className="text-sm">
